...
const SHADING_PRESETS: Preset[] = [
  ...
  },
  {
    ...
    options: [
      { key: 'celBands', label: 'Shade Bands', type: 'slider', default: 3,
        range: [2, 5, 1] },
      { key: 'rimStr', label: 'Rim Light', type: 'slider', default: 0.6,
        range: [0, 1, 0.05] },
    ...
    config: {
      ...
      celBands: 3, rimStr: 0.6, saturation: 1.3, outlineColor: '#1a0d26',
    },
  ...
  },
  {
    ...
    options: [
      ...
      { key: 'halftoneScale', label: 'Dot Size', type: 'slider', default: 3.0,
        range: [2, 8, 0.5] },
      { key: 'outlineThickness', label: 'Outline Thickness', type: 'slider', default: 3.0,
        range: [1, 6, 0.25] },
